...
def cross_run_stability(
    ...
    -------
    dict with keys:
        "rank_corr"      — mean pairwise Spearman correlation (higher better)
        "sign_agreement" — fraction of the top-k features (by mean |attribution|)
                           whose sign is identical in every run (higher better)
